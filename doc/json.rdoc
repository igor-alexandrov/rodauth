...
json_request_content_type_regexp :: The regexp to use to recognize a request as a json request.  This is matched against the media type of the request, without any Content-Type parameters.
...
json_request? :: Whether the current request is a JSON request, looks at the media type of the Content-Type request header by default.
